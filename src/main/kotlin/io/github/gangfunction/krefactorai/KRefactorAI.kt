...
class KRefactorAI(
    ...
    private fun createEmptyPlan(): RefactoringPlan {
    ...
    private fun enhancePlanWithAI(plan: RefactoringPlan): RefactoringPlan {
     ...
     */
    private fun addAISuggestions(steps: List<RefactoringStep>): List<RefactoringStep> =
        runBlocking {
            steps.map { step ->
                try {
                    val suggestion =
                        openAIClient?.generateRefactoringSuggestion(
